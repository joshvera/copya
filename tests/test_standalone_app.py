...
class StandaloneAppTest(unittest.TestCase):
    def test_native_swift_source_is_not_a_jinja_template(self) -> None:
        ...
        self.assertIn('static let bundleIdentifier = "com.joshvera.copya"', source)
        self.assertIn('static let monitorLaunchdLabel = "com.joshvera.copya.agent"', source)
    ...
    def test_app_bundle_resources_are_valid_plists(self) -> None:
        ...
        agent = plistlib.loads((ROOT / "Resources" / "com.joshvera.copya.agent.plist").read_bytes())

        self.assertEqual(info["CFBundleName"], "COPYA")
        self.assertEqual(info["CFBundleExecutable"], "COPYA")
        self.assertEqual(info["CFBundleIdentifier"], "com.joshvera.copya")
        ...
        self.assertEqual(agent["Label"], "com.joshvera.copya.agent")
